...
<div class="container" style="max-width: 970px;">
    ...
    <c:if test="${not empty cteated}">
        ...
        <div class="alert alert-success">
            <p>Item was successfully added.</p>
            <p>You can upload it's image now.</p>
        </div>
    </c:if>
    <c:if test="${not empty submitDone}">
        <input type="hidden" id="modelAttr" name="modelAttr" value="${submitDone}"/>
        <div class="alert alert-success">
            <p>Item was successfully created.</p>
        </div>
    </c:if>
    ...
    <c:if test="${not empty cteated}">
        <form:form class="form-horizontal" id="productaddimage" action="${window.location.pathname}" method="post"
            ...
            <div class="input-group">
                <span class="input-group-addon" for="filebutton">Upload image</span>
                <div class="col-md-4">
            ...
            <div>
                <button class="btn btn-primary col-md-offset-6" type="submit" id="createButton">Upload</button>
            </div>
