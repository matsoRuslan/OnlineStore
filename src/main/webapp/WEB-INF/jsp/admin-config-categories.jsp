...
<ul class="nav nav-pills">
    ...
    <li role="presentation" class="active"><a href="/home/admin-config/edit-categories">Edit categories</a></li>
...
<div class="well">
    ...
    <a class="btn btn-primary col-md-offset-1" href="/home/admin-config/adm-add-category">Add category</a>
</div>
...
<script src="<c:url value='/resources/js/admin-config-categories.js'/>"></script>
</html>